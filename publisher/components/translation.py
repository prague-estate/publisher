...
_i8n = {
    ...
    'filters.button.min_price.custom.enabled': {'en': '✅ Custom', 'ru': '✅ Задать'},
    'filters.button.min_price.custom.disabled': {'en': 'Custom', 'ru': 'Задать'},
    ...
    'filters.button.max_price.custom.enabled': {'en': '✅ Custom', 'ru': '✅ Задать'},
    'filters.button.max_price.custom.disabled': {'en': 'Custom', 'ru': 'Задать'},
