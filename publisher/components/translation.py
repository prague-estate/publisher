...
_i8n = {
    ...
    'invoice.description': {
        ...
        'ru': 'Уведомления о новых квартирах прямо в вашем Телеграм. Быстрее конкурентов 🦈',
    },
    ...
    'filters.button.prev_page': {'en': '◀️', 'ru': '◀️'},
    'filters.button.next_page': {'en': '▶️', 'ru': '▶️'},
    ...
    'filters.button.district.enabled': {'en': 'District number ✅', 'ru': 'Район (номер) ✅'},
    'filters.button.district.disabled': {'en': 'District number ⚙', 'ru': 'Район (номер) ⚙'},
    'filters.button.district_name.enabled': {'en': 'District title ✅', 'ru': 'Район (название) ✅'},
    'filters.button.district_name.disabled': {'en': 'District title ⚙', 'ru': 'Район (название) ⚙'},
    ...
    'filters.button.district.name.enabled': {'en': '✅ {0}', 'ru': '✅ {0}'},
    'filters.button.district.name.disabled': {'en': '{0}', 'ru': '{0}'},
