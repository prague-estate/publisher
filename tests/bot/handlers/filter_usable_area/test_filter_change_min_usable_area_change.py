...
async def test_filter_change_min_usable_area_change_process_happy_path(payload: str, success: bool):
    ...
    if success:
        ...
        assert get_user_settings(user_id=1).min_usable_area == int(payload)
